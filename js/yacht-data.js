const yates = [
    ...
    },
    {
        nombre: "59' Azimut",
        nombre_en: "59' Azimut",
        imagenes: ["59 Azimut/59_ Azimut 1.jpeg", "59 Azimut/59_ Azimut 2.jpeg", "59 Azimut/59_ Azimut 3.jpeg", "59 Azimut/59_ Azimut 4.jpeg", "59 Azimut/59_ Azimut 5.jpeg", "59 Azimut/59_ Azimut 6.jpeg", "59 Azimut/59_ Azimut 7.jpeg"],
        ...
        waterToys: "Equipo de snorkel, 2 Cañas de pesca, 2 Paddle boards, 1 Lilypad",
        descripcion: "El Azimut 59’ es la combinación perfecta entre elegancia italiana, confort absoluto y rendimiento en el mar. Diseñado para quienes buscan una experiencia náutica de alto nivel, este yate ofrece espacios amplios, acabados de lujo y una navegación suave y segura. Cuenta con flybridge panorámico, ideal para relajarse, tomar el sol o disfrutar de momentos inolvidables con vistas espectaculares. Sus áreas exteriores e interiores están pensadas para el entretenimiento y la comodidad, con una distribución inteligente que maximiza cada espacio. En el interior, el Don Joni dispone de cabinas privadas finamente equipadas, una sala luminosa con diseño moderno y una cocina totalmente funcional, creando un ambiente sofisticado y acogedor. Su potencia y estabilidad garantizan una travesía placentera, perfecta tanto para recorridos costeros como para escapadas exclusivas. Ideal para charters privados, celebraciones especiales o días de lujo en el mar, el Azimut 59’ Don Joni transforma cada travesía en una experiencia inolvidable.",
...
function traducirDescripcion(descripcion, lang) {
    ...
    const traducciones = {
        ...
        "El Sea Ray 27 es una embarcación versátil y elegante, perfecta para quienes buscan comodidad, diversión y rendimiento en el mar. Con un diseño compacto y moderno, combina maniobrabilidad con espacios bien distribuidos, ofreciendo una experiencia náutica ágil y placentera. Su cockpit abierto permite disfrutar del sol y del entorno mientras se navega o se fondea, ideal para salidas de día. La zona de mando está diseñada para un control seguro y cómodo, mientras que los asientos acolchados y áreas de descanso garantizan confort para todos los pasajeros. Una embarcación perfecta para quienes buscan libertad, diversión y momentos inolvidables en el mar.": "The Sea Ray 27 is a versatile and elegant vessel, perfect for those seeking comfort, fun and performance at sea. With a compact and modern design, it combines maneuverability with well-distributed spaces, offering an agile and pleasant nautical experience. Its open cockpit allows you to enjoy the sun and surroundings while sailing or at anchor, ideal for day trips. The command area is designed for safe and comfortable control, while padded seats and rest areas guarantee comfort for all passengers. A perfect vessel for those seeking freedom, fun and unforgettable moments at sea.",
        ...
        "El Azimut 59’ es la combinación perfecta entre elegancia italiana, confort absoluto y rendimiento en el mar. Diseñado para quienes buscan una experiencia náutica de alto nivel, este yate ofrece espacios amplios, acabados de lujo y una navegación suave y segura. Cuenta con flybridge panorámico, ideal para relajarse, tomar el sol o disfrutar de momentos inolvidables con vistas espectaculares. Sus áreas exteriores e interiores están pensadas para el entretenimiento y la comodidad, con una distribución inteligente que maximiza cada espacio. En el interior, el Don Joni dispone de cabinas privadas finamente equipadas, una sala luminosa con diseño moderno y una cocina totalmente funcional, creando un ambiente sofisticado y acogedor. Su potencia y estabilidad garantizan una travesía placentera, perfecta tanto para recorridos costeros como para escapadas exclusivas. Ideal para charters privados, celebraciones especiales o días de lujo en el mar, el Azimut 59’ Don Joni transforma cada travesía en una experiencia inolvidable.": "The Azimut 59’ is the perfect combination of Italian elegance, absolute comfort and performance at sea. Designed for those seeking a high-level nautical experience, this yacht offers spacious areas, luxury finishes and smooth, safe navigation. It features a panoramic flybridge, ideal for relaxing, sunbathing or enjoying unforgettable moments with spectacular views. Its exterior and interior areas are designed for entertainment and comfort, with an intelligent distribution that maximizes every space. Inside, Don Joni features finely equipped private cabins, a bright room with modern design and a fully functional kitchen, creating a sophisticated and welcoming atmosphere. Its power and stability guarantee a pleasant crossing, perfect for both coastal tours and exclusive getaways. Ideal for private charters, special celebrations or luxury days at sea, the Azimut 59’ Don Joni transforms every voyage into an unforgettable experience."
    };
